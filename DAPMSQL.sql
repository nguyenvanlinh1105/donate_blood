...
N'Diện tích tối thiểu 150m²; Đủ ánh sáng, thông thoáng; Có điện, nước, nhà vệ sinh; Địa điểm thuận tiện, có khu vực đỗ xe; Có bàn ghế và nơi nghỉ tạm.',
...
('SK00000004', 'TBDK000004', 'CSTN000004', GETDATE(), N'Từ chối', 200, 90, N'Đã hủy', DATEADD(DAY, 13, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000005', 'TBDK000005', 'CSTN000005', GETDATE(), N'Đã duyệt', 220, 140, N'Đã duyệt', DATEADD(DAY, 14, GETDATE()), DATEADD(DAY, 15, GETDATE()), DATEADD(DAY, 15, GETDATE()), GETDATE(), GETDATE()),
...
('SK00000011', 'TBDK000011', 'CSTN000011', GETDATE(), N'Đã duyệt', 230, 160, N'Đã duyệt', DATEADD(DAY, 20, GETDATE()), DATEADD(DAY, 21, GETDATE()), DATEADD(DAY, 21, GETDATE()), GETDATE(), GETDATE()),
('SK00000012', 'TBDK000012', 'CSTN000012', GETDATE(), N'Từ chối', 90, 80, N'Đã hủy', DATEADD(DAY, 21, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000013', 'TBDK000013', 'CSTN000013', GETDATE(), N'Đã duyệt', 200, 170, N'Đã duyệt', DATEADD(DAY, 22, GETDATE()), DATEADD(DAY, 23, GETDATE()), DATEADD(DAY, 23, GETDATE()), GETDATE(), GETDATE()),
...
('SK00000015', 'TBDK000015', 'CSTN000015', GETDATE(), N'Đã duyệt', 190, 180, N'Đã duyệt', DATEADD(DAY, 24, GETDATE()), DATEADD(DAY, 25, GETDATE()), DATEADD(DAY, 25, GETDATE()), GETDATE(), GETDATE()),
('SK00000016', 'TBDK000016', 'CSTN000016', GETDATE(), N'Đã hủy', 250, 90, N'Đã hủy', DATEADD(DAY, 25, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000017', 'TBDK000017', 'CSTN000017', GETDATE(), N'Đã duyệt', 130, 190, N'Đã duyệt', DATEADD(DAY, 26, GETDATE()), DATEADD(DAY, 27, GETDATE()), DATEADD(DAY, 27, GETDATE()), GETDATE(), GETDATE()),
...
('SK00000019', 'TBDK000019', 'CSTN000019', GETDATE(), N'Đã duyệt', 90, 200, N'Đã duyệt', DATEADD(DAY, 28, GETDATE()), DATEADD(DAY, 29, GETDATE()), DATEADD(DAY, 29, GETDATE()), GETDATE(), GETDATE()),
('SK00000020', 'TBDK000020', 'CSTN000020', GETDATE(), N'Từ chối', 230, 100, N'Đã hủy', DATEADD(DAY, 29, GETDATE()), NULL, NULL, GETDATE(), GETDATE());

...
100, '2025-05-30', '2025-05-30', '2025-06-19', '2025-06-09', NULL),
...
150, '2025-05-31', '2025-05-31', '2025-06-20', '2025-06-09', NULL),
...
120, '2025-06-02', '2025-06-02', '2025-06-22', '2025-06-09', NULL),
...
200, '2025-06-01', '2025-06-01', '2025-06-21', '2025-06-09', NULL),
...
220, '2025-06-04', '2025-06-04', '2025-07-04', '2025-06-09', NULL),
...
180, '2025-06-03', '2025-06-03', '2025-06-23', '2025-06-09', NULL),
...
160, '2025-06-08', '2025-06-08', '2025-06-28', '2025-06-09', NULL),
...
190, '2025-06-01', '2025-06-01', '2025-07-01', '2025-06-09', NULL),
...
180, '2025-05-31', '2025-05-31', '2025-06-30', '2025-06-09', NULL),
...
130, '2025-06-06', '2025-06-06', '2025-06-26', '2025-06-09', NULL),
...
230, '2025-06-05', '2025-06-05', '2025-07-05', '2025-06-09', NULL),
...
90, '2025-06-04', '2025-06-04', '2025-06-24', '2025-06-09', NULL),
...
200, '2025-06-02', '2025-06-02', '2025-07-02', '2025-06-09', NULL),
...
250, '2025-06-07', '2025-06-07', '2025-07-07', '2025-06-09', NULL),
...
INSERT INTO DangKiToChucHienMau (
    IdSuKien, IdThongBaoDK, IdCoSoTinhNguyen, NgayDangKi, TinhTrangDK, SoLuongDK, SoLuongDDK, TrangThaiSuKien, HanDK, TgBatDauSK, TgKetThucSK, NgayTao, NgaySua
)
VALUES
...
('SK00000002', 'TBDK000002', 'CSTN000002', GETDATE(), N'Chờ duyệt', 150, 100, N'Chưa duyệt', DATEADD(DAY, 11, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000003', 'TBDK000003', 'CSTN000003', GETDATE(), N'Đã duyệt', 120, 180, N'Đã duyệt', DATEADD(DAY, 12, GETDATE()), DATEADD(DAY, 13, GETDATE()), DATEADD(DAY, 13, GETDATE()), GETDATE(), GETDATE()),
('SK00000004', 'TBDK000004', 'CSTN000004', GETDATE(), N'Từ chối', 200, 90, N'Chưa duyệt', DATEADD(DAY, 13, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000005', 'TBDK000005', 'CSTN000005', GETDATE(), N'Đã duyệt', 220, 140, N'Chưa duyệt', DATEADD(DAY, 14, GETDATE()), DATEADD(DAY, 15, GETDATE()), DATEADD(DAY, 15, GETDATE()), GETDATE(), GETDATE()),
('SK00000006', 'TBDK000006', 'CSTN000006', GETDATE(), N'Chờ duyệt', 180, 80, N'Chưa duyệt', DATEADD(DAY, 15, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000007', 'TBDK000007', 'CSTN000007', GETDATE(), N'Đã duyệt', 160, 130, N'Đã duyệt', DATEADD(DAY, 16, GETDATE()), DATEADD(DAY, 17, GETDATE()), DATEADD(DAY, 17, GETDATE()), GETDATE(), GETDATE()),
('SK00000008', 'TBDK000008', 'CSTN000008', GETDATE(), N'Đã hủy', 190, 100, N'Đã hủy', DATEADD(DAY, 17, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000009', 'TBDK000009', 'CSTN000009', GETDATE(), N'Đã duyệt', 180, 150, N'Đã duyệt', DATEADD(DAY, 18, GETDATE()), DATEADD(DAY, 19, GETDATE()), DATEADD(DAY, 19, GETDATE()), GETDATE(), GETDATE()),
('SK00000010', 'TBDK000010', 'CSTN000010', GETDATE(), N'Chờ duyệt', 130, 110, N'Chưa duyệt', DATEADD(DAY, 19, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000011', 'TBDK000011', 'CSTN000011', GETDATE(), N'Đã duyệt', 230, 160, N'Chưa duyệt', DATEADD(DAY, 20, GETDATE()), DATEADD(DAY, 21, GETDATE()), DATEADD(DAY, 21, GETDATE()), GETDATE(), GETDATE()),
('SK00000012', 'TBDK000012', 'CSTN000012', GETDATE(), N'Từ chối', 90, 80, N'Đã hủy', DATEADD(DAY, 21, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000013', 'TBDK000013', 'CSTN000013', GETDATE(), N'Đã duyệt', 200, 170, N'Chưa duyệt', DATEADD(DAY, 22, GETDATE()), DATEADD(DAY, 23, GETDATE()), DATEADD(DAY, 23, GETDATE()), GETDATE(), GETDATE()),
('SK00000014', 'TBDK000014', 'CSTN000014', GETDATE(), N'Chờ duyệt', 220, 120, N'Chưa duyệt', DATEADD(DAY, 23, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000015', 'TBDK000015', 'CSTN000015', GETDATE(), N'Đã duyệt', 190, 180, N'Chưa duyệt', DATEADD(DAY, 24, GETDATE()), DATEADD(DAY, 25, GETDATE()), DATEADD(DAY, 25, GETDATE()), GETDATE(), GETDATE()),
('SK00000016', 'TBDK000016', 'CSTN000016', GETDATE(), N'Đã hủy', 250, 90, N'Chưa duyệt', DATEADD(DAY, 25, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000017', 'TBDK000017', 'CSTN000017', GETDATE(), N'Đã duyệt', 130, 190, N'Chưa duyệt', DATEADD(DAY, 26, GETDATE()), DATEADD(DAY, 27, GETDATE()), DATEADD(DAY, 27, GETDATE()), GETDATE(), GETDATE()),
('SK00000018', 'TBDK000018', 'CSTN000018', GETDATE(), N'Chờ duyệt', 200, 130, N'Chưa duyệt', DATEADD(DAY, 27, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000019', 'TBDK000019', 'CSTN000019', GETDATE(), N'Đã duyệt', 90, 200, N'Chưa duyệt', DATEADD(DAY, 28, GETDATE()), DATEADD(DAY, 29, GETDATE()), DATEADD(DAY, 29, GETDATE()), GETDATE(), GETDATE()),
('SK00000020', 'TBDK000020', 'CSTN000020', GETDATE(), N'Từ chối', 230, 100, N'Chưa duyệt', DATEADD(DAY, 29, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000021', 'TBDK000001', 'CSTN000010', GETDATE(), N'Đã duyệt', 140, 110, N'Chưa duyệt', DATEADD(DAY, 30, GETDATE()), DATEADD(DAY, 31, GETDATE()), DATEADD(DAY, 31, GETDATE()), GETDATE(), GETDATE()),
('SK00000022', 'TBDK000002', 'CSTN000009', GETDATE(), N'Chờ duyệt', 170, 90, N'Chưa duyệt', DATEADD(DAY, 31, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000023', 'TBDK000003', 'CSTN000008', GETDATE(), N'Đã duyệt', 130, 160, N'Chưa duyệt', DATEADD(DAY, 32, GETDATE()), DATEADD(DAY, 33, GETDATE()), DATEADD(DAY, 33, GETDATE()), GETDATE(), GETDATE()),
('SK00000024', 'TBDK000004', 'CSTN000007', GETDATE(), N'Từ chối', 180, 80, N'Chưa duyệt', DATEADD(DAY, 33, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000025', 'TBDK000005', 'CSTN000006', GETDATE(), N'Đã duyệt', 200, 140, N'Chưa duyệt', DATEADD(DAY, 34, GETDATE()), DATEADD(DAY, 35, GETDATE()), DATEADD(DAY, 35, GETDATE()), GETDATE(), GETDATE()),
('SK00000026', 'TBDK000006', 'CSTN000005', GETDATE(), N'Chờ duyệt', 160, 100, N'Chưa duyệt', DATEADD(DAY, 35, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000027', 'TBDK000007', 'CSTN000004', GETDATE(), N'Đã duyệt', 150, 120, N'Đã duyệt', DATEADD(DAY, 36, GETDATE()), DATEADD(DAY, 37, GETDATE()), DATEADD(DAY, 37, GETDATE()), GETDATE(), GETDATE()),
('SK00000028', 'TBDK000008', 'CSTN000003', GETDATE(), N'Đã hủy', 190, 110, N'Đã hủy', DATEADD(DAY, 37, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000029', 'TBDK000009', 'CSTN000002', GETDATE(), N'Đã duyệt', 170, 130, N'Đã duyệt', DATEADD(DAY, 38, GETDATE()), DATEADD(DAY, 39, GETDATE()), DATEADD(DAY, 39, GETDATE()), GETDATE(), GETDATE()),
('SK00000030', 'TBDK000010', 'CSTN000001', GETDATE(), N'Chờ duyệt', 140, 100, N'Chưa duyệt', DATEADD(DAY, 39, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000031', 'TBDK000001', 'CSTN000020', GETDATE(), N'Đã duyệt', 210, 150, N'Đã duyệt', DATEADD(DAY, 40, GETDATE()), DATEADD(DAY, 41, GETDATE()), DATEADD(DAY, 41, GETDATE()), GETDATE(), GETDATE()),
('SK00000032', 'TBDK000002', 'CSTN000019', GETDATE(), N'Từ chối', 100, 90, N'Đã hủy', DATEADD(DAY, 41, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000033', 'TBDK000003', 'CSTN000018', GETDATE(), N'Đã duyệt', 180, 160, N'Đã duyệt', DATEADD(DAY, 42, GETDATE()), DATEADD(DAY, 43, GETDATE()), DATEADD(DAY, 43, GETDATE()), GETDATE(), GETDATE()),
('SK00000034', 'TBDK000004', 'CSTN000017', GETDATE(), N'Chờ duyệt', 220, 120, N'Chưa duyệt', DATEADD(DAY, 43, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000035', 'TBDK000005', 'CSTN000016', GETDATE(), N'Đã duyệt', 190, 170, N'Đã duyệt', DATEADD(DAY, 44, GETDATE()), DATEADD(DAY, 45, GETDATE()), DATEADD(DAY, 45, GETDATE()), GETDATE(), GETDATE()),
('SK00000036', 'TBDK000006', 'CSTN000015', GETDATE(), N'Đã hủy', 240, 100, N'Đã hủy', DATEADD(DAY, 45, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000037', 'TBDK000007', 'CSTN000014', GETDATE(), N'Đã duyệt', 130, 180, N'Đã duyệt', DATEADD(DAY, 46, GETDATE()), DATEADD(DAY, 47, GETDATE()), DATEADD(DAY, 47, GETDATE()), GETDATE(), GETDATE()),
('SK00000038', 'TBDK000008', 'CSTN000013', GETDATE(), N'Chờ duyệt', 200, 110, N'Chưa duyệt', DATEADD(DAY, 47, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000039', 'TBDK000009', 'CSTN000012', GETDATE(), N'Đã duyệt', 110, 190, N'Đã duyệt', DATEADD(DAY, 48, GETDATE()), DATEADD(DAY, 49, GETDATE()), DATEADD(DAY, 49, GETDATE()), GETDATE(), GETDATE()),
('SK00000040', 'TBDK000010', 'CSTN000011', GETDATE(), N'Từ chối', 230, 100, N'Đã hủy', DATEADD(DAY, 49, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000041', 'TBDK000001', 'CSTN000015', GETDATE(), N'Đã duyệt', 150, 120, N'Đã duyệt', DATEADD(DAY, 50, GETDATE()), DATEADD(DAY, 51, GETDATE()), DATEADD(DAY, 51, GETDATE()), GETDATE(), GETDATE()),
('SK00000042', 'TBDK000002', 'CSTN000016', GETDATE(), N'Chờ duyệt', 180, 100, N'Chưa duyệt', DATEADD(DAY, 51, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000043', 'TBDK000003', 'CSTN000017', GETDATE(), N'Từ chối', 200, 90, N'Đã hủy', DATEADD(DAY, 52, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000044', 'TBDK000004', 'CSTN000018', GETDATE(), N'Đã hủy', 170, 110, N'Đã hủy', DATEADD(DAY, 53, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000045', 'TBDK000005', 'CSTN000019', GETDATE(), N'Đã duyệt', 190, 130, N'Chưa duyệt', DATEADD(DAY, 54, GETDATE()), DATEADD(DAY, 55, GETDATE()), DATEADD(DAY, 55, GETDATE()), GETDATE(), GETDATE()),
('SK00000046', 'TBDK000006', 'CSTN000001', GETDATE(), N'Chờ duyệt', 160, 140, N'Chưa duyệt', DATEADD(DAY, 55, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000047', 'TBDK000007', 'CSTN000002', GETDATE(), N'Đã duyệt', 210, 150, N'Chưa duyệt', DATEADD(DAY, 56, GETDATE()), DATEADD(DAY, 57, GETDATE()), DATEADD(DAY, 57, GETDATE()), GETDATE(), GETDATE()),
('SK00000048', 'TBDK000008', 'CSTN000003', GETDATE(), N'Từ chối', 140, 100, N'Chưa duyệt', DATEADD(DAY, 57, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000049', 'TBDK000009', 'CSTN000004', GETDATE(), N'Đã duyệt', 220, 160, N'Chưa duyệt', DATEADD(DAY, 58, GETDATE()), DATEADD(DAY, 59, GETDATE()), DATEADD(DAY, 59, GETDATE()), GETDATE(), GETDATE()),
('SK00000050', 'TBDK000010', 'CSTN000005', GETDATE(), N'Chờ duyệt', 130, 110, N'Chưa duyệt', DATEADD(DAY, 59, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000051', 'TBDK000001', 'CSTN000005', GETDATE(), N'Đã duyệt', 230, 170, N'Chưa duyệt', DATEADD(DAY, 60, GETDATE()), DATEADD(DAY, 61, GETDATE()), DATEADD(DAY, 61, GETDATE()), GETDATE(), GETDATE()),
('SK00000052', 'TBDK000002', 'CSTN000006', GETDATE(), N'Đã hủy', 180, 120, N'Chưa duyệt', DATEADD(DAY, 61, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000053', 'TBDK000003', 'CSTN000007', GETDATE(), N'Đã duyệt', 200, 140, N'Chưa duyệt', DATEADD(DAY, 62, GETDATE()), DATEADD(DAY, 63, GETDATE()), DATEADD(DAY, 63, GETDATE()), GETDATE(), GETDATE()),
('SK00000054', 'TBDK000004', 'CSTN000008', GETDATE(), N'Chờ duyệt', 150, 100, N'Chưa duyệt', DATEADD(DAY, 63, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000055', 'TBDK000005', 'CSTN000009', GETDATE(), N'Từ chối', 240, 130, N'Đã hủy', DATEADD(DAY, 64, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000056', 'TBDK000006', 'CSTN000015', GETDATE(), N'Đã duyệt', 170, 150, N'Chưa duyệt', DATEADD(DAY, 65, GETDATE()), DATEADD(DAY, 66, GETDATE()), DATEADD(DAY, 66, GETDATE()), GETDATE(), GETDATE()),
('SK00000057', 'TBDK000007', 'CSTN000016', GETDATE(), N'Chờ duyệt', 190, 110, N'Chưa duyệt', DATEADD(DAY, 66, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000058', 'TBDK000008', 'CSTN000017', GETDATE(), N'Đã duyệt', 210, 160, N'Đã duyệt', DATEADD(DAY, 67, GETDATE()), DATEADD(DAY, 68, GETDATE()), DATEADD(DAY, 68, GETDATE()), GETDATE(), GETDATE()),
('SK00000059', 'TBDK000009', 'CSTN000018', GETDATE(), N'Từ chối', 160, 120, N'Chưa duyệt', DATEADD(DAY, 68, GETDATE()), NULL, NULL, GETDATE(), GETDATE()),
('SK00000060', 'TBDK000010', 'CSTN000019', GETDATE(), N'Đã duyệt', 220, 170, N'Chưa duyệt', DATEADD(DAY, 69, GETDATE()), DATEADD(DAY, 70, GETDATE()), DATEADD(DAY, 70, GETDATE()), GETDATE(), GETDATE());
